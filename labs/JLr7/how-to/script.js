let { clockHours, clockMinutes, clockSeconds } = window;
...
function draw(timestamp) {
    ...
    clockMinutes.textContent = minute;
    clockSeconds.textContent = pad2(second);
...
watch.style.visibility = "visible"; // Avoid FOUC
let isRandomFlashing = false;
let dottedLines = document.querySelector('.dotted-lines');
dottedLines.style.visibility = "visible"; // Avoid FOUC
